...
export default function UnmarkedUpload({ goBack }) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // ⛔ Close SSE connection after it's done
      eventSource.close();
    }
  };
            ...
            <div className="dropzone" onClick={handleChooseFile}>
              <div className="dropzone-icon">
                ...
                >
                  ...
                  />
                  <path
                    d="M20 21H4C3.44772 21 3 20.5523 3 20V19C3 18.4477 3.44772 18 4 18H20C20.5523 18 21 18.4477 21 19V20C21 20.5523 20.5523 21 20 21Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          {status === "no_file" && (
            <div className="status-message error">
              ...
              >
                ...
                />
                <path
                  d="M10.93 2.93L3.93 9.93C3.32843 10.5316 3 11.3388 3 12.18V19C3 19.5304 3.21071 20.0391 3.58579 20.4142C3.96086 20.7893 4.46957 21 5 21H19C19.5304 21 20.0391 20.7893 20.4142 20.4142C20.7893 20.0391 21 19.5304 21 19V12.18C21 11.3388 20.6716 10.5316 20.07 9.93L13.07 2.93C12.7794 2.6394 12.3978 2.47754 12 2.47754C11.6022 2.47754 11.2206 2.6394 10.93 2.93Z"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
